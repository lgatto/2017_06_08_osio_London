...
development environemnt. *Lingua franca* of
statistics. State-of-the-art visualisation libraries (`ggplot2`) and
data manipulation (`dplytr`) in addition to from-the-shelf
capabilites. R and markdown integration for report generation.
...
and an interactive environemnt/notbook (`jupyter`).
